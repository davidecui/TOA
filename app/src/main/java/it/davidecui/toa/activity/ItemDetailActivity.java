 ...
 * more than a {@link it.davidecui.toa.fragment.ItemDetailFragment}.
 */
public class ItemDetailActivity extends TOAActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindService(getUpdateServiceIntent(), new TOAUpdateServiceConnection(this), Context.BIND_AUTO_CREATE);
    }
    ...
    public void updateContent(TOAContent data) {
        ((ItemDetailFragment) getFragmentManager()
